...
lazy_static! {
    pub static ref ARGS_STRUCT: ArgMatches = {
        ...
        ClapCommand::new("LFM")
            .version(VERSION)
            .about("LFM, a Linux-first file manager")
            .arg(
                Arg::new("reveal")
                    .short('r')
                    .long("reveal")
                    .help("Reveal file in LFM")
                    .takes_value(false),
            )
            .subcommand(
                ClapCommand::new("extensions")
                    .alias("ext")
                    .about("Manage Files extensions")
                    .subcommand(
            ...
            .arg(
                Arg::new("dir")
                    .help("Directories to open in LFM")
                    .multiple_values(true)
                    .takes_value(true),
            )
            .arg(
...
#[tauri::command]
#[inline]
fn change_transparent_effect(_effect: String, _window: tauri::WebviewWindow) {
    return;
}
...
#[tauri::command]
#[inline]
fn enable_shadow_effect(_effect: bool, _window: tauri::WebviewWindow) {
    return;
}
...
async fn main() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            files_api::get_file_permissions,
            files_api::set_file_permissions,
