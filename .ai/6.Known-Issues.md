...
- `src-ui/features/explorer/components/ActionToolbar.vue`
...
- `src-ui/layouts/components/AppHeader`
...
- `src-ui/layouts/components/AppNavigationBar.vue`
...
- tauri-plugin-libmpv (This will take a long time)
  - <https://docs.rs/tauri-plugin-libmpv/latest/>.
- ffmpeg-next (Better Alternatives for Thumbnail Generation in Rust)
...
## 12. [] PDF review support file `src-ui/components/ui/PDFPreview.vue`
...
8. Search System
9. File Icons
10. [Done] Multimedia/Preview Research
