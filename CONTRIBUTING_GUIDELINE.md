...
- **Structure**: New frontend features should go into `src/features/<feature-name>`.
- **Styling**: Use the design tokens defined in `src/styles/main.sass`.
- **Types**: Always use TypeScript and provide proper type definitions.
- **Migration**: If you are porting code from `src/legacy/`, ensure it follows the new modular structure.
