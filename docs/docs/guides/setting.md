...
You can open settings on Files by clicking the `Settings` button on the left down of Files.
...
You can exit from Settings on Files by clicking on the upside left of Files.
...
You can change Files's app theme on the `Appearance` tab of the Settings. Available default themes are `light`, `light+`, `dark`, and `dark+`. Besides, there is a `System Default` theme that will automatically read your system preference, also you can [try custom themes](/docs/Extensions/theme/).
...
![Files's infobar](/img/docs/infobar.webp)
...
Hide Windows' system files on Files.
:::tip
