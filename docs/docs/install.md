...
You can download Files from the installer [here](https://github.com/softeng/Files/releases).

## For Linux

### AppImages

Grab the **.AppImage** file in the [releases](https://github.com/softeng/Files/releases) page and follow this [guide](https://docs.appimage.org/introduction/quickstart.html#how-to-run-an-appimage).

### Debian and Ubuntu based distros

Grab the **.deb** file in the [releases](https://github.com/softeng/Files/releases) page.
...
Grab the **.pacman** file in the [releases](https://github.com/softeng/Files/releases) page.
...
build from [source](https://aur.archlinux.org/Files-bin.git)
...
This is actually not an error, it's a design choice by Microsoft to protect those of us who are not tech-savvy (i.e. potentially your friends) from a virus. You don't need to worry about the safety of Files in this case since it's [open source](https://github.com/softeng/Files) and you can inspect the code or even build your own version!
...
<details>
<summary>
<code>“Files” cannot be opened because the developer cannot be verified.</code> Error on macOS
</summary>
...
Please address an issue [here](https://github.com/softeng/Files/issues/new/choose).
