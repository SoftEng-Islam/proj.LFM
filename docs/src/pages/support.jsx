...
const CONTRIBUTORS_API = 'https://api.github.com/repos/softeng/Files/contributors'; // fetches atmost 30 contributors from github
	...
	return (
		<div className="supports margin-vert--xl">
			...
			<p className="supports-description">
				<Translate id="supports.descriptionPart1">Files is an Open Source project that</Translate>{' '}
					...
					<Link to={contributor.html_url} key={contributor.id}>
						<div className="supports-contributor">
							<img
								...
								alt={`${contributor.login} has contributed ${contributor.contributions} times to Files`}
							/>
