...
const PoweredByTheWeb = () => {
	return (
		<div className="padding-top--xl powered-by-web padding-bottom--l">
			<h1>
				<Translate id="about.title">Cross-platform File EFiles.</Translate>
			...
			<span className="powered-by-web--desc">
				...
				<Translate id="about.promise">Files promises you an unprecedented experience.</Translate>
			</span>
			<div className="row margin-top--lg">
				...
				<div className="col col--6 padding--md features-container">
					<div className="feature margin-bottom--md">
						...
						<p>
							<Translate id="feature.multipleTabsDescription">
								Tired of opening multiple windows to explore your files? Files comes with multiple tabs support to help you manage
								your files easier.
							</Translate>
						</p>
					</div>
					<div className="feature margin-bottom--md">
						...
						<p>
							<Translate id="feature.filePreviewDescriptionPart1">Files comes with a</Translate>{' '}
				...
				<div className="col feature padding--md">
					...
					<p>
						<Translate id="feature.customizableDescriptionPart1">
							You can customize the look and feel of Files by using different themes or
						</Translate>{' '}
