...
Puoi scaricare Files dall'installer [qui](https://github.com/softeng/Files/releases).

## Per Linux

### AppImages

Prendi il file **.AppImage** nella [pagina delle release](https://github.com/softeng/Files/releases) e segui questa [guida](https://docs.appimage.org/introduction/quickstart.html#how-to-run-an-appimage).

### Debian e distribuzioni Linux basate su Ubuntu

Prendi il file **.deb** nella pagina [releases](https://github.com/softeng/Files/releases).
...
Prendi il file **.pacman** nella pagina [releases](https://github.com/softeng/Files/releases).
...
compilarlo dalla [sorgente](https://aur.archlinux.org/Files-bin.git)
...
<summary>
<code>“Files” non può essere aperto perché lo sviluppatore non può essere verificato.</code> Errore su macOS
</summary>
...
Si prega di segnalare il problema [qui](https://github.com/softeng/Files/issues/new/choose).
