...
Puoi aprire le impostazioni su Files facendo clic sul pulsante `Impostazioni` in basso a sinistra di Files.
...
È possibile uscire da Impostazioni su Files cliccando sulla sinistra superiore di Files.
...
È possibile modificare il tema dell'app di Files sulla scheda `Aspetto` delle impostazioni. I temi predefiniti disponibili sono `light`, `light+`, `dark`, e `dark+`. Inoltre, c'è un tema `Predefinito di sistema` che leggerà automaticamente le preferenze di sistema, è possibile anche [provare i temi personalizzati](/docs/Extensions/theme/).
...
È possibile modificare la famiglia di caratteri di Files nella scheda `Aspetto` delle impostazioni con una delle famiglie di caratteri installate sul sistema.

### Dimensione del Carattere

È possibile modificare la dimensione del carattere di Files nella scheda `Aspetto` delle Impostazioni. Si prega di notare che la dimensione del carattere ideale è compresa tra 10px e 30px.

### Trasparenza delle Finestre

È possibile rendere la finestra Files trasparente nela scheda `Aspetto` delle impostazioni impostando le seguenti opzioni. Si prega di notare che la trasparenza ideale è compresa tra il 70% e il 100%. È possibile disabilitare la trasparenza disabilitando tutte le opzioni della trasparenza.
...
:::warning Questo potrebbe causare un crash di Files.

Questo perché Files analizza l'icona dall'exe e se l'esadecimale del file exe è rotto, Files si blocca.
...
Qualsiasi contributo per chiamarlo direttamente da Files è benvenuto. :::
...
Un'opzione per visualizzare la barra delle informazioni sullo spazio di lavoro. ![Barra delle informazioni di Files](/img/docs/infobar.webp)

## Preferenze

### Lingua Dell'Applicazione

Traduci Files. Aiutaci a tradurre Files, [guarda questa discussione](https://github.com/softeng/Files/discussions/30).

### Nascondi file nascosti

Nascondi i file nascosti su Files, puoi trovare questa impostazione nella scheda `Preferenze` su Files o dalla sua scorciatoia, `Ctrl + H`.

### Nascondi File Di Sistema

Nascondi i file di sistema di Windows su Files. :::tip Scopri cosa è il file di sistema [in questa pagina wikipedia](https://en.wikipedia.org/wiki/System_file). Basta disabilitaro se non si capisce cosa è. :::

### Elenca e ordina le directory insieme ai file

Se disabilitato, Files darà la priorità alle directory sopra i file.
...
Abilitando questa opzione Files aprirà un file con doppio clic. Altrimenti, aprirà un file con un singolo clic.

### All'avvio

Opzioni disponibili all'avvio di Files. Le opzioni disponibili sono:
