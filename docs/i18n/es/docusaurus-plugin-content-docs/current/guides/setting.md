...
Puede abrir la configuración en Files haciendo clic en el botón `Configuración` a la izquierda de Files.
...
Puede salir de Ajustes en Files haciendo clic en el lado superior izquierdo de Files.
...
Puedes cambiar el tema de la aplicación de Files en la pestaña `Apariencia` de la configuración. Los temas por defecto disponibles son `luz`, `luz +`, `oscuro`y `oscuro +`. Además, hay un tema `Predeterminado del Sistema` que leerá automáticamente su preferencia del sistema, también puede [probar temas personalizados](/docs/Extensions/theme/).
...
Puede cambiar la familia de fuentes de Files en la pestaña `Apariencia` de la configuración a una de las familias de fuentes instaladas en su sistema.

### Tamaño de la fuente

Puedes cambiar el tema de la aplicación de Files en la pestaña `Apariencia` de la configuración. Tenga en cuenta que un tamaño de fuente ideal está entre 10px y 30px.

### Transparencia de la ventana

Hacer transparente la ventana de Files en la pestaña `Apariencia` de la configuración combinando las siguientes opciones. Tenga en cuenta que una transparencia ideal está entre el 70 % y el 100 %. Puede desactivar la transparencia desactivando todas las opciones de transparencia.
...
:::advertencia Esto podría hacer que Files se bloqueara.

Esto se debe a que Files analiza el icono desde el exe y si el hexadecimal del archivo exe está roto, Files falla.
...
Cualquier contribución para llamarla directamente desde Files es bienvenida. :::
...
Una opción para mostrar la barra de información en el área de trabajo. ![Infobar de Files](/img/docs/infobar.webp)

## Preferencias

### Idioma de la aplicación

Localizar Files. Ayúdanos a traducir Files, [mira esta discusión](https://github.com/softeng/Files/discussions/30).

### No mostrar archivos ocultos

Ocultar archivos ocultos en Files, puede encontrar esta configuración en la pestaña `Preferencia` en Files o por su atajo de teclado `Ctrl + H`.

### Ocultar archivos del sistema

Ocultar archivos de sistema de Windows en Files. :::tip Aprende lo que es el archivo del sistema [en esta wikipedia](https://en.wikipedia.org/wiki/System_file). Sólo apaga si no entiendes lo que es. :::

### Listar y ordenar directorios junto con archivos

Si está deshabilitado, Files priorizará los directorios sobre los archivos.
