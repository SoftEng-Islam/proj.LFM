...
:::caution Ce guide implique de modifier le registre de Windows, assurez-vous de créer une sauvegarde préalablement pour récupérer si vous avez un problème avec Files. Veuillez garder à l'esprit que cette méthode peut ne pas fonctionner pour tout le monde.
