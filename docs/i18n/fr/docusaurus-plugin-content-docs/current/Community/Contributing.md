...
Files est actuellement en cours de développement. Nous souhaitons la bienvenue aux contributeurs pour collaborer sur Files.

## Impliquez-vous

Il y a plusieurs façons de contribuer à Files, et beaucoup d'entre eux n'impliquent pas d'écrire de code. Voici quelques idées pour commencer:

- Commencez à utiliser Files dès aujourd'hui ! Parcourez les guides du Tutoriel. Est-ce que tout fonctionne comme prévu? Dans le cas contraire, nous sommes toujours à la recherche d'améliorations. Faites-le nous savoir en nous le signalant.
- Regardez les [problèmes Files](https://github.com/softeng/Files/issues). Si vous trouvez un problème que vous voulez corriger, [ouvrez une pull request](#first-pull-request). Les issues marquées comme [Good first issue](https://github.com/softeng/Files/labels/good%20first%20issue) sont un bon point de départ.
...
- Jetez un œil aux [discussions GitHub](https://github.com/softeng/Files/discussions) et donnez votre avis dans une discussion ou envisagez d'ouvrir une pull request si vous voyez quelque chose sur lequel vous voulez travailler.

Les contributions sont toujours les bienvenues!

## Processus de développement

Files utilise [GitHub](https://github.com/softeng/Files) comme source de vérité. L’équipe de base y travaillera directement. Tous les changements seront publics dès le début.

### Signaler de nouvelles issues. {#issues}

Lorsque vous [ouvrez un nouveau ticket](https://github.com/softeng/Files/issues), assurez-vous toujours de remplir le modèle de fiche. Nous utilisons les tickets GitHub pour suivre les bogues publics. Veuillez vous assurer que votre description est claire et qu'elle contient des instructions suffisantes pour pouvoir reproduire le problème.
...
Nous utilisons [GitHub Discussions](https://github.com/softeng/Files/discussions) et [GitHub Issues](https://github.com/softeng/Files) pour suivre les idées des utilisateurs. Suggérez une nouvelle fonctionnalité [ici](https://github.com/softeng/Files/discussions/new)! Les demandes de fonctionnalités ont tendance à avoir:
...
1. Après le clonage du dépôt, exécutez `yarn` à la racine du dépôt et exécutez `yarn` dans le dossier `docs` (si vous voulez travailler sur Files Docs).
2. Pour démarrer Files localement, exécutez `yarn dev`.

    Pour démarrer un serveur de développement local servant la documentation de Files, allez dans le répertoire `docs` et exécutez `yarn start`

### Gitpod for Files's development {#gitpod-env}

The easiest way to run Files in Gitpod is to use the [Gitpod](https://gitpod.io/) service, all what you need to do is to click the button below and log in with your GitHub account. Afterwards, you will see a VS Code-like environment where you can start developing and pushing your changes. Please note that you may have to wait up to minutes to get Files running on the poped up VNC tab.

## [![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#/https://github.com/softeng/Files)
...
## Working on Files docs

Files documentation website is built using [Docusaurus 2](https://docusaurus.io/), and its code is located at [`docs`](https://github.com/softeng/Files/tree/master/docs) folder.
...
We have a list of [beginner-friendly issues](https://github.com/softeng/Files/labels/good%20first%20issue) to help you get your feet wet in the Files codebase and familiar with our contribution process. This is a great place to get started.
...
1. Forcez [le dépôt](https://github.com/softeng/Files) et créez votre branche à partir du `maître`.
2. Effectuez des changements et assurez-vous que votre message de commit est compréhensible.
3. Ouvrez une PR [](https://github.com/softeng/Files/pulls) et assurez-vous de décrire clairement votre pull request .

## Working on Files resources

### Localisation

We host our locales on the [crowdin](https://crwd.in/Files). To translate it, please follow these steps:

- Inscrivez-vous sur [Crowdin](https://crowdin.com) et rejoignez notre projet [ici](https://crwd.in/Files).
- Assurez-vous que votre locale existe là-bas, si elle n'existe pas, laisser un commentaire dans [cette discussion](https://github.com/softeng/Files/discussions/30) et j'ajouterai l'option langue :)
