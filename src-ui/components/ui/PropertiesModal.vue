...
Teleport(to="body")
	Transition(
		...
		div(v-if="show" class="fixed inset-0 z-[10000] bg-black/40 backdrop-blur-[4px] flex items-center justify-center" @click.self="emit('close')")
			div(
				class="bg-base-100 border border-base-content/10 rounded-xl w-[360px] p-5 shadow-[0_20px_40px_rgba(0,0,0,0.5)]"
				v-motion
				...
				div(class="mb-5")
					...
					div(class="h-[1px] bg-base-content/10 my-4 opacity-50")
					div(class="flex mb-3 gap-3")
