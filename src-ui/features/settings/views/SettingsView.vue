						...
						div.LFM-tab-pane(v-show="activeTab === 'appearance'")
							fieldset.LFM-settings-group
								...
								.LFM-control
									...
									select#theme(class="select select-bordered w-full" v-model="store.config.appearance.theme" @change="store.applyLiveConfig()")
								...
								.LFM-control
									...
									select#iconSize(class="select select-bordered w-full" v-model="store.config.appearance.icon_size" @change="store.applyLiveConfig()")
								...
								.LFM-control
									...
									select#fontSize(class="select select-bordered w-full" v-model="store.config.appearance.font_size" @change="store.applyLiveConfig()")
								...
								.LFM-control
									...
									select#hiddenFilesVisualStyle(class="select select-bordered w-full" v-model="store.config.appearance.hidden_files_visual_style" @change="store.applyLiveConfig()")
...
.LFM-button {
	@apply inline-flex items-center justify-center rounded-xl bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed;
}
</style>
